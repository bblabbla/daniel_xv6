...
int main() {
  ...
  18:	376080e7          	jalr	886(ra) # 38a <pipe>
  pipe(q);
  1c:	fe040513          	addi	a0,s0,-32
  20:	00000097          	auipc	ra,0x0
  24:	36a080e7          	jalr	874(ra) # 38a <pipe>
  int pid = fork();
  28:	00000097          	auipc	ra,0x0
  2c:	34a080e7          	jalr	842(ra) # 372 <fork>
  if (pid == 0) {
  30:	ed2d                	bnez	a0,aa <main+0xaa>
    read(p[0], buf, 1);
  32:	4605                	li	a2,1
  34:	fd840593          	addi	a1,s0,-40
  38:	fe842503          	lw	a0,-24(s0)
  3c:	00000097          	auipc	ra,0x0
  40:	356080e7          	jalr	854(ra) # 392 <read>
    printf("%d: received ping\n", getpid());
  44:	00000097          	auipc	ra,0x0
  48:	3b6080e7          	jalr	950(ra) # 3fa <getpid>
  4c:	85aa                	mv	a1,a0
  4e:	00001517          	auipc	a0,0x1
  52:	85250513          	addi	a0,a0,-1966 # 8a0 <malloc+0xf0>
  56:	00000097          	auipc	ra,0x0
  5a:	69c080e7          	jalr	1692(ra) # 6f2 <printf>
    write(q[1], buf, 1);
  5e:	4605                	li	a2,1
  60:	fd840593          	addi	a1,s0,-40
  64:	fe442503          	lw	a0,-28(s0)
  68:	00000097          	auipc	ra,0x0
  6c:	332080e7          	jalr	818(ra) # 39a <write>
  } else {
    write(p[1], buf, 1);
    read(q[0], buf, 1);
  ...
  close(p[0]);
  70:	fe842503          	lw	a0,-24(s0)
  74:	00000097          	auipc	ra,0x0
  78:	32e080e7          	jalr	814(ra) # 3a2 <close>
  close(p[1]);
  7c:	fec42503          	lw	a0,-20(s0)
  80:	00000097          	auipc	ra,0x0
  84:	322080e7          	jalr	802(ra) # 3a2 <close>
  close(q[0]);
  88:	fe042503          	lw	a0,-32(s0)
  8c:	00000097          	auipc	ra,0x0
  90:	316080e7          	jalr	790(ra) # 3a2 <close>
  close(q[1]);
  94:	fe442503          	lw	a0,-28(s0)
  98:	00000097          	auipc	ra,0x0
  9c:	30a080e7          	jalr	778(ra) # 3a2 <close>
  exit(0);
  a0:	4501                	li	a0,0
  a2:	00000097          	auipc	ra,0x0
  a6:	2d8080e7          	jalr	728(ra) # 37a <exit>
    write(p[1], buf, 1);
  aa:	4605                	li	a2,1
  ...
  dc:	7e050513          	addi	a0,a0,2016 # 8b8 <malloc+0x108>
  e0:	00000097          	auipc	ra,0x0
  e4:	612080e7          	jalr	1554(ra) # 6f2 <printf>
  e8:	b761                	j	70 <main+0x70>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 462:	47a50513          	addi	a0,a0,1146 # 8d8 <digits>
 466:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 52e:	3aeb8b93          	addi	s7,s7,942 # 8d8 <digits>
 ...
 66e:	26690913          	addi	s2,s2,614 # 8d0 <malloc+0x120>
        while(*s != 0){
